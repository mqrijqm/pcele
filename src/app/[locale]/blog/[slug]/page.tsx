  ...
  return (
    <div className="header-offset">
      <section className="relative overflow-hidden border-b border-[#73552E]/15 bg-linen section-padding-sm">
        <div className="container relative z-10">
          <Link
            ...
            className="reveal inline-flex items-center gap-2 text-sm font-semibold text-[#73552E] transition-colors hover:text-[#73552E]"
          >
          ...
          <div className="mt-10 max-w-4xl">
            ...
            <h1 className="reveal stagger-2 mt-5 font-display text-5xl font-semibold leading-[1.02] tracking-[-0.045em] text-[#73552E] md:text-7xl">
              {post.title[locale]}
            </h1>
            <div className="reveal stagger-3 mt-6 flex flex-wrap items-center gap-4 text-sm text-[#73552E]">
              <span className="inline-flex items-center gap-1.5">
                <Calendar className="h-4 w-4 text-[#73552E]" />
                {t('blog.publishedLabel')} {post.date[locale]}
              </span>
              <span className="h-1 w-1 rounded-full bg-[#73552E]/[0.06]" aria-hidden="true" />
              <span className="inline-flex items-center gap-1.5">
                <Clock className="h-4 w-4 text-[#73552E]" />
      ...
      <div className="container -mt-8 md:-mt-12">
        <div className="relative mx-auto aspect-[16/9] max-w-5xl overflow-hidden border border-[#73552E]/15 shadow-[0_20px_40px_-15px_rgba(115,85,46,0.18)] md:aspect-[21/9] rounded-[0.6rem]">
          <Image
            src={post.image}
          ...
          <div className="mx-auto max-w-prose">
            {post.body[locale].map((block, index) =>
              block.t === 'h2' ? (
                ...
                <p key={index} className="mb-5 text-base leading-relaxed text-[#73552E]">
                  {block.text}
                </p>
              )
            )}
