      ...
      "sections": [
        ...
        },
        {
          ...
          "blocks": [
            {
              "t": "p",
              "text": "U Prodavnici nudimo prirodne pčelinje proizvode - med (bagremov, livadski, šumski i druge vrste), propolis i polen, proizvedene na našem porodičnom pčelinjaku u okolini Mračaja. Fotografije i opisi proizvoda na sajtu predstavljaju vjeran prikaz proizvoda, ali stvarni izgled (boja, konzistencija) meda može neznatno varirati u zavisnosti od godišnjeg doba i izvora nektara, što je prirodna karakteristika, a ne nedostatak."
            },
            {
              "t": "p",
