    ...
    >
      <div className="mx-auto max-w-[1440px] px-5 pt-8 sm:px-8 lg:px-12 lg:pt-12">
        <div className="relative flex flex-col">
          ...
          <div
            className={`relative z-10 -mt-10 w-[94%] border border-[#b9822c]/55 bg-[#faf4e8] p-7 shadow-[0_24px_70px_rgba(57,43,32,0.12)] sm:w-[76%] sm:p-10 lg:absolute lg:top-1/2 lg:mt-0 lg:-translate-y-1/2 lg:p-14 ${cardWidth} ${
          ...
          >
            ...
            <h1
              className={`mt-5 font-display text-5xl font-medium leading-[0.98] tracking-[-0.04em] text-[#332a24] sm:text-6xl ${headingClamp}`}
            >
              {heading}
            </h1>
            <p className="mt-7 max-w-lg text-base leading-7 text-[#66594f]">{description}</p>
            <p className="mt-8 border-t border-[#332a24]/15 pt-4 font-display text-lg italic text-[#82601f]">
              {note}
            </p>
          </div>
        </div>
