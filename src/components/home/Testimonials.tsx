...
export default function Testimonials({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="relative overflow-hidden bg-[#FFF7E6] py-24 lg:py-32">
      <div className="container">
        <div className="grid gap-12 lg:grid-cols-[0.34fr_0.66fr] lg:gap-16">
          <div className="reveal lg:sticky lg:top-28 lg:self-start">
            ...
            <h2 className="mt-5 font-display text-4xl font-medium leading-[1.06] tracking-[-0.04em] text-[#8A5A2B] sm:text-5xl">
              {copy.heading}
            </h2>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            {rest.map((quote, index) => (
              <figure
                key={quote.author}
                className={`reveal stagger-${index + 1} border-t border-[#8A5A2B]/15 px-1 py-7 sm:p-7`}
              >
                <blockquote className="font-display text-xl font-medium leading-snug text-[#8A5A2B] lg:text-2xl">
