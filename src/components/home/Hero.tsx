...
export default function Hero({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="relative overflow-hidden bg-[#F6EEDB] pt-24 text-[#8A5A2B]">
      <div className="relative mx-auto min-h-[46rem] max-w-[1440px] px-5 pb-8 pt-14 sm:px-10 lg:min-h-[50rem] lg:px-16 lg:pb-0 lg:pt-16 xl:px-20">
        <div className="relative z-20 max-w-[36rem] lg:pt-24">
          ...
          <div className="mt-9 flex flex-wrap items-center gap-7">
            <Link
              ...
              className="group inline-flex min-h-12 items-center gap-3 rounded-full bg-[#8A5A2B] px-7 py-3.5 text-sm font-semibold text-[#FFF7E6] transition-colors duration-300 hover:bg-[#7A8A6B]"
            >
              {copy.ctaProducts}
        ...
        <div className="relative z-10 mt-14 h-[31rem] lg:absolute lg:bottom-0 lg:right-0 lg:top-16 lg:mt-0 lg:h-auto lg:w-[57%]">
          <div className="absolute inset-x-0 top-0 h-[75%] overflow-hidden rounded-[9rem_9rem_2.5rem_2.5rem] bg-[#7A8A6B] lg:left-[12%]">
            <Image
          ...
          <div className="absolute bottom-0 left-[-4%] h-[72%] w-[55%] overflow-hidden rounded-[2.5rem] bg-[#F6EEDB] shadow-[0_24px_70px_rgba(138,90,43,0.16)] lg:left-0 lg:w-[53%]">
            <Image
        ...
        <div
          className="absolute bottom-0 left-0 hidden h-[5.25rem] w-full rounded-t-[3rem] bg-[#7A8A6B] lg:block"
          aria-hidden="true"
        />
      </div>
    </section>
