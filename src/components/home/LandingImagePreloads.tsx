const RASTER_ASSETS = [
  ...
  '/images/proizvodi/livadski-1kg-new.png',
  '/images/proizvodi/livadski-500g-new.png',
  '/images/proizvodi/bagremov-1kg-new.png',
  '/images/proizvodi/bagremov-500g-new.png',
