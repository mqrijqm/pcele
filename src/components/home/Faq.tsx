    ...
    <section className="relative overflow-hidden bg-[#73552E]/[0.06] py-24 lg:py-32">
      <div className="container relative z-10">
        <div className="grid gap-12 lg:grid-cols-[0.36fr_0.64fr] lg:items-start lg:gap-20">
          ...
          <div className="reveal stagger-1 border-t border-[#73552E]/20">
            {copy.items.map((item, index) => {
              const isOpen = openIndex === index;
              return (
                <div key={item.question} className="border-b border-[#73552E]/20">
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`mt-1 h-5 w-5 shrink-0 text-[#73552E] transition-transform duration-300 ${
                        isOpen ? 'rotate-180' : ''
                      }`}
                    />
                  </button>
                  ...
                  >
                    <p className="max-w-2xl pb-8 pl-10 text-base leading-relaxed text-[#73552E] sm:pl-[4.25rem]">
                      {item.answer}
                    </p>
                  </div>
                </div>
