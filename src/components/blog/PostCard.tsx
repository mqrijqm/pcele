    ...
    <Link href={localeHref(locale, `/blog/${post.slug}`)} className="group block">
      <article className="transition-transform duration-300 group-hover:-translate-y-1">
        ...
        <div className="border-b border-[#73552E]/15 px-1 py-6">
          <div className="flex items-center gap-3 text-xs uppercase tracking-wider text-[#73552E]">
          ...
          <p className="mt-2 line-clamp-3 text-sm leading-relaxed text-[#73552E]">
            {post.excerpt[locale]}
          </p>
          <span className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-[#73552E] transition-colors group-hover:text-[#73552E]">
            {t('blog.readMore')}
