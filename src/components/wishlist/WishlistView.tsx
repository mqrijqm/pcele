          ...
          {items.length === 0 ? (
            <div className="mt-14 flex flex-col items-center border border-[#73552E]/15 bg-[#FDF9DC] px-6 py-20 text-center rounded-[1.5rem]">
              ...
              <Link
                ...
                className="mt-7 inline-flex min-h-12 items-center rounded-full bg-[#73552E] px-7 text-sm font-semibold text-[#FDF9DC] transition-colors hover:bg-[#C79A3B] hover:text-[#73552E]"
              >
