    ...
    <div className="bg-ivory header-offset">
      <section className="section-padding">
        <div className="container">
          ...
          {items.length === 0 ? (
            <div className="mt-14 flex flex-col items-center border border-[#885B27]/15 bg-[var(--paper)] px-6 py-20 text-center rounded-[0.6rem]">
              ...
              {items.map((product) => (
                <div key={product.slug} className="relative">
                  <button
                    ...
                    className="absolute right-4 top-4 z-10 rounded-full flex h-9 w-9 items-center justify-center border border-[#885B27]/15 bg-[var(--paper)]/85 text-[#885B27] backdrop-blur-sm transition-colors hover:border-[#EEC660] hover:text-[#885B27]"
                  >
                    <X className="h-4 w-4" />
                  </button>
                  <TransitionLink
                  ...
                  >
                    <div
                      className="relative flex aspect-[4/4.8] items-center justify-center overflow-hidden border border-[#885B27]/25 bg-transparent p-8"
                    >
                      <Image
                        src={product.image}
